...
class PointDataset(CVDataset):
    ...
    def __sample_prompt(self, mask, p = 0.5):
        ...
        object = np.random.choice(non_border_pxiels)
    ...
    def __getitem__(self, i):
        ...
        # Reformatting the mask for this binary point based segmentation task
        ...
        # if not concat heatmap, heatmap is returned seperately, useful for plotting and debugging
